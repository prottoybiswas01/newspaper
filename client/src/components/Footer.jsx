...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#111111] text-neutral-400 dark:bg-[#050505] mt-12 border-t border-neutral-800 pt-16 pb-8 no-print">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            {/* Subscription Form */}
            <div className="bg-[#181818] p-6 rounded-2xl border border-neutral-800 max-w-md">
              <h4 className="text-sm font-bold text-white mb-2 uppercase tracking-wide">নিউজলেটার সাবস্ক্রাইব করুন</h4>
              <p className="text-xs text-neutral-400 mb-4">প্রতিদিনের বাছাইকৃত সংবাদ সকালে আপনার ইনবক্সে পেতে সাবস্ক্রাইব করুন।</p>
              ...
              {success ? (
                ...
                <form onSubmit={handleSubscribe} className="flex space-x-2">
                  <input 
                    ...
                    required
                    className="flex-1 px-4 py-2 text-sm bg-[#0f0f0f] border border-neutral-700 rounded-lg text-neutral-200 focus:outline-none focus:border-red-500"
                  />
                  <button 
                    type="submit" 
                    disabled={submitting}
                    className="px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-800 text-white rounded-lg text-sm font-bold flex items-center justify-center transition-colors"
                  >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-white font-bold text-sm mb-4 uppercase tracking-wide">বিভাগসমূহ (Categories)</h4>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="pt-4">
                <Link to="/contact" className="hover:text-white transition-colors block font-semibold text-red-500">যোগাযোগ করুন</Link>
              </li>
            </ul>
          </div>
        </div>
